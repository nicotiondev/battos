...
type Querier interface {
	...
	CancelRun(ctx context.Context, id pgtype.UUID) (Run, error)
	ClaimNextQueuedRun(ctx context.Context) (Run, error)
	ClaimQueuedRunByID(ctx context.Context, id pgtype.UUID) (Run, error)
	...
	CountAuditLogs(ctx context.Context) (int32, error)
	...
	CreateNovaConversation(ctx context.Context, userID pgtype.Text) (NovacoreConversation, error)
	...
	EnableRunNetwork(ctx context.Context, id pgtype.UUID) (Run, error)
	...
	GetNovaConversation(ctx context.Context, id pgtype.UUID) (NovacoreConversation, error)
	...
	GetUsageByRun(ctx context.Context, runID pgtype.UUID) ([]UsageEvent, error)
	...
	ListNovaMessagesByConversation(ctx context.Context, conversationID pgtype.UUID) ([]NovacoreMessage, error)
	ListProjects(ctx context.Context) ([]Project, error)
	ListProviders(ctx context.Context) ([]Provider, error)
	ListRepositories(ctx context.Context) ([]Repository, error)
	ListRepositoriesByProject(ctx context.Context, projectID string) ([]Repository, error)
	ListRunLogs(ctx context.Context, runID pgtype.UUID) ([]RunLog, error)
